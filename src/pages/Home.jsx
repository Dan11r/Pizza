...
const Home = React.memo(() => {
    const [pizzasItems, pizzasIsLoading, category, sortBy] = useSelector((state) =>
        [state.pizzas.pizzasItems, state.pizzas.isLoading, state.filter.category, state.filter.sortBy])
    return (
